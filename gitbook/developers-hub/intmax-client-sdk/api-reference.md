...
[**Q.** INTMAX ネットワークにおける「ログイン」とは？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-what-is-login-in-the-context-of-the-intmax-network)
...
intMaxClient.updatePublicClientRpc(newRpcUrl);
```
...
[Q. `tokenList` と `tokenBalances` とは？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-what-are-tokenlist-and-tokenbalances)
...
[Q. Transfer とトランザクションの違いは？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-what-is-the-difference-between-a-transfer-and-a-transaction)
...
- [Q. INTMAX ネットワークのトランザクション手数料はどのように決まりますか？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-how-are-transaction-fees-determined-on-the-intmax-network)
- [Q. 複数のトランザクションをバッチ処理した場合、手数料はどうなりますか？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-what-happens-to-transaction-fees-when-multiple-transactions-are-batched-together)
- [Q. `broadcastTransaction` の戻り値はどのように使いますか？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-how-do-we-use-the-return-value-of-broadcasttransaction-and-withdraw)
...
[Q. `claimWithdrawal` とは？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-what-is-claimwithdrawal)
...
- [Q. INTMAX ネットワークのトランザクション手数料はどのように決まりますか？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-how-are-transaction-fees-determined-on-the-intmax-network)
- [Q. コラテラル手数料（collateral fee）とは？](/gitbook/developers-hub/intmax-client-sdk/faq.md#q-what-is-the-collateral-fee)
...
```tsx
const transferFee: FeeResponse = await client.getTransferFee();

...
![Withdraw from Mining Portfolio](assets/user-guides/withdraw_10.webp)
...
![Withdraw from Mining Portfolio](assets/user-guides/withdraw_20.webp)

確認ページで詳細を確認し、問題がなければ**「Confirm」**ボタンをクリックして Withdrawal プロセスを完了します。

![Withdraw from Mining Portfolio](assets/user-guides/withdraw_30.webp)

...
[Vibe Coding — 開発プロンプト集](/gitbook/developers-hub/intmax-client-sdk/vibe-coding-for-coding-prompt.md)

セットアップではなく **実際の開発**に迅速に移行する手助けとしての一例として **スターターテンプレート**（Vite + TypeScript、Next.js、Node.js 等）集。

> **ガイダンス：**
>
> - 下記のスタータープロンプトを確認してください。
> - `intmax2-client-sdk` を使用した dApp テンプレートを生成し、　　
> -  開発にとりくみましょう。

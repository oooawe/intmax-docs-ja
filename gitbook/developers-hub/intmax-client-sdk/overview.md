...
[統合ガイドを開く](/gitbook/developers-hub/intmax-client-sdk/integration-guide.md)
...
詳細は [API リファレンス](/gitbook/developers-hub/intmax-client-sdk/api-reference.md#batch-size-limits) を参照してください。
